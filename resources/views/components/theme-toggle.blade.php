<button @click="darkMode=!darkMode" type="button" class="relative inline-flex flex-shrink-0 h-6 mr-5 transition-colors duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer bg-red-100 dark:bg-zinc-700 w-11 focus:outline-none focus:ring-2 focus:ring-neutral-100 focus:ring-offset-2" role="switch" aria-checked="false">
