                        ...
                        @foreach($category->snacks as $snack)
                            <div class="flex items-center my-1 mr-4">
                                <input type="radio"
                                    ...
                                    class="w-5 h-5 text-red-600 bg-white border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
